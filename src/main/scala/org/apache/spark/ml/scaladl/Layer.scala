...
import org.apache.spark.mllib.scaladl.optimization._
 ...
 *
 */
private[scaladl] trait Layer extends Serializable {
 ...
 */
private[scaladl] trait LayerModel extends Serializable {
 ...
 */
private[scaladl] class AffineLayer(val numIn: Int, val numOut: Int) extends Layer {
 ...
 */
private[scaladl] object AffineLayerModel {
 ...
 */
private[scaladl] trait ActivationFunction extends Serializable {
 ...
 */
private[scaladl] class SigmoidFunction extends ActivationFunction {
...
private[scaladl] class ReluFunction extends ActivationFunction {
  ...
  override def eval: (Double) => Double = x => if (x > 0) x else 0

  override def derivative: (Double) => Double = z => if (z > 0) 1 else 0
}
 ...
 */
private[scaladl] class FunctionalLayer (val activationFunction: ActivationFunction) extends Layer {
 ...
 */
private[scaladl] class FunctionalLayerModel private[scaladl] (val layer: FunctionalLayer)
  extends LayerModel {
...
/**
 * Trait for the artificial neural network (scaladl) topology properties
 */
private[scaladl] trait Topology extends Serializable {
 ...
 */
private[scaladl] trait TopologyModel extends Serializable {
 ...
 */
private[scaladl] class FeedForwardTopology private(val layers: Array[Layer]) extends Topology {
...
private[ml] object FeedForwardTopology {
  ...
  /**
   * Creates a Autoencoder
   *
   * @param layerSizes sizes of layers including input and output size
   * @return Autoencoder topology
   */
  def autoencoder(
 ...
 */
private[scaladl] object FeedForwardModel {
 ...
 */
private[scaladl] class ANNGradient(topology: Topology, dataStacker: DataStacker) extends Gradient {
 ...
 */
private[scaladl] class DataStacker(stackSize: Int, inputSize: Int, outputSize: Int)
 ...
 * Simple updater
 */
private[scaladl] class ANNUpdater extends Updater {
